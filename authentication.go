...
func (p plugin) Meta() meta.Meta {
	return &meta.Data{
		...
		Dependencies: []meta.Dependency{
			interfaces.AuthInterface.Dependency(),
			interfaces.MailInterface.Dependency(),
			interfaces.CacheInterface.Dependency(),
			interfaces.HttpInterface.Dependency(),
			interfaces.HttpTransportInterface.Dependency(),
			interfaces.SQLInterface.Dependency(),
			interfaces.SessionInterface.Dependency(),
		},
